...
var atpl1 = {
	...
	"Тематични шаблони..." : "-",
	"Биография инфо" : "Шаблон:Меню1/Биография инфо",
	...
	"Тенисист" : "Шаблон:Меню1/Тенисист",
...
var atpl2 = {
	...
	"Шаблони за статии" : {
		...
		"Микромъниче" : "Шаблон:Меню2/Микромъниче",
		"Обработка" : "Шаблон:Меню2/Обработка",
		"Пояснение" : "Шаблон:Меню2/Пояснение",
		"Редактирам" : "Шаблон:Меню2/Редактирам",
	...
	"Шаблони за картинки" : {
		"Картинка инфо" : "Шаблон:Меню2/Картинка инфо",
	...
	"Шаблони за шаблони" : {
		"Навигационен шаблон" : "Шаблон:Меню2/Навигационен шаблон",
		"Шаблон на мъниче" : "Шаблон:Меню2/Шаблон на мъниче",
		"Includeonly" : "Шаблон:Меню2/Includeonly",
		"Noinclude" : "Шаблон:Меню2/Noinclude"
	}
};

var tplVarBaseName = "atpl";
