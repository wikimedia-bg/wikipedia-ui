...
"cat-template" : ["{"+"{категория", "", "}}", "Шаблон:Категория"],
...
"table" : ["\n{|\n|\n|-\n|\n|}", "", "", "Таблица"],
"ekip" : ["{"+"{Екип отбор\n|дом-тяло=orange\n|дом-ръкави=orange\n|дом-шорти=black\n|дом-чорапи=orange\n\n|гост-тяло=green\n|гост-ръкави=green\n|гост-шорти=black\n|гост-чорапи=green\n", "", "}}", "Екип отбор"],
"license" : ["{"+"{без лиценз|15:46, 27 ноември 2007 (UTC)", "", "}}", "Без лиценз"]
};

var tpl1 = {
	// "SHOWN TEXT" : "PAGE NAME",
	"(Меню 1)" : "Избери тематичен шаблон...",
...
var tpl2 = {
	"(Меню 2)" : "-",
	"БЛАБЛА 3.1" : {
		"Блабла 3.2.1" : "Шаблон:Блабла/празен",
		"Блабла 3.2.2" : "Шаблон:Блабла/празен",
	},
	"Блабла 3.2" : "Шаблон:Блабла/празен",
	"Блабла 3.3" : "Шаблон:Блабла/празен",
};
